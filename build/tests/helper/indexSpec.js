...
describe("Test the main images endpoint", function () {
    it("Test if image 'flag.jpg' exist", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, test.get("/images?file_name=flag&width=50&height=50").expect(200)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
describe("Test resize", function () {
    it("Test image flag is exist", function () { return __awaiter(void 0, void 0, void 0, function () {
        var data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, resize_1.resize)("flag", 50, 50)];
                case 1:
                    data = _a.sent();
